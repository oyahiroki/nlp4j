...
public class Hello2_Add1024_2 {
	...
	public static void main(String[] args) throws Exception {
		...
		JsonObject jo1 = DocumentUtil.toJsonObject(doc1);
...
//					inputDocument.addField("field2_ss", ss); // *_ss
					...
					inputDocument.addField("id", doc1.getId());
					inputDocument.addField("address_s", doc1.getAttribute("address"));
					inputDocument.addField("brand_s", doc1.getAttribute("brand"));
