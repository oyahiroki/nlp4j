...
//			int sequence = (idxChunks + 1);

//			System.err.println("head=" + chunkHead + ",id=" + chunkId);

			// // surface, reading, baseform, pos, feature
...
//				System.err.println("map.put: " + fullMorphemId);
		...
		for (String key : map.keySet()) {
			DefaultKeywordWithDependency kwd = map.get(key);
//			System.err.println("(" + key + ")" + kwd.getLex() + " -> " + kwd.getDependencyKey());
			if (map.get(kwd.getDependencyKey()) != null) {
...
//		for (KeywordWithDependency kwd : roots) {
