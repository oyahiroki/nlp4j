 ...
 *
 */
public class WordNetJaConvert1Glosses1ja {

	public static void main(String[] args) throws Exception {

		WordNetConverterGlosses converter = new WordNetConverterGlosses();

		String dir = "/usr/local/wordnet/ja/";

		String fileName = dir + "jpn_wn_lmf.xml.gz";
		File inFile = new File(fileName);

		String licenseFileName = dir + "license.txt";
		File licenseFile = new File(licenseFileName);

		String outFileName = dir + "jpn_wn_lmf_glosses_json_" + System.currentTimeMillis() + ".txt";
