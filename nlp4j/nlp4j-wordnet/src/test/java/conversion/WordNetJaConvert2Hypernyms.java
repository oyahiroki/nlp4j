 ...
 *
 */
public class WordNetJaConvert2Hypernyms {
...
//		File outFile = new File(outFileName);
		File outFile = File.createTempFile("jpn_wn_lmf_hypernyms_json", ".txt", new File("/usr/local/data/wordnetja/"));
//		if (outFile.exists()) {
//			System.err.println("Exists: " + outFile.getAbsolutePath());
//			return;
//		}

		String licenseFileName = "/usr/local/data/wordnetja/license.txt";
		...
		String license = FileUtils.readFileToString(licenseFile, "UTF-8");
		{
			...
			doc.addProperty("url", "https://github.com/oyahiroki/nlp4j-resources/blob/main/wordnet/");
			doc.addProperty("url_raw",
					"https://raw.githubusercontent.com/oyahiroki/nlp4j-resources/main/wordnet/jpn_wn_lmf_hypernyms_json.txt");
...
////			System.err.println(JsonUtils.prettyPrint(doc));

			{
				...
				for (String hypernym : db.findHypernyms(entry.getLemmaWrittenForm())) {
					hypernyms.add(hypernym);
				}
				doc.add("hypernyms", hypernyms);
			}
