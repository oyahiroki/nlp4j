...
import nlp4j.wiki.util.WikipediaTextParser;

public class WikipediaTextParserTestCase extends TestCase {

	public void testParse() {
		String text = "{{Otheruses}}\r\n" //
				+ "{{複数の問題\r\n" //
				+ "| 出典の明記 = 2021年3月\r\n" //
				+ "| 更新 = 2021年3月\r\n" //
				+ "}}\r\n" //
		...
		WikipediaTextParser parser = new WikipediaTextParser();

		parser.parseTopParagraph(text);
	}
