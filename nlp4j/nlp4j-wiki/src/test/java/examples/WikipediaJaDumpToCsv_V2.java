...
public class WikipediaJaDumpToCsv_V2 {
	...
	public static void main(String[] args) throws Exception {
		...
		String out_csvFileName = dir + lang + media + "-20230101-pages-abstract_categories.csv";
		...
		WikiPageHandler wikiPageHander = new WikiPageHandler() {
			...
			public void read(WikiPage page) throws BreakException {
				if (page != null && page.getNamespace().equals("0")) {
					...
					try {
						csv_writer.write(title, abst_text, categories);
					} catch (IOException e) {
