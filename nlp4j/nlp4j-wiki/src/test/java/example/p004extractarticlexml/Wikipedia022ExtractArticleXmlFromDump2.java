 ...
 *
 */
public class Wikipedia022ExtractArticleXmlFromDump2 {

	public static void main(String[] args) throws Exception {

		// String itemString = "りんご";
		String itemString = "靴";
		...
		String outFile = "src/test/resources/nlp4j.wiki/jawiki-20221101-pages-articles-multistream-{id}.xml";
		...
		try (WikiDumpReader dumpReader = new WikiDumpReader(dumpFile, indexFile);) {
			...
			File outF = new File(outFile.replace("{id}", page.getId()));
