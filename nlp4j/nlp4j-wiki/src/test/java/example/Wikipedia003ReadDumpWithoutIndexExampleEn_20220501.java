...
public class Wikipedia003ReadDumpWithoutIndexExampleEn_20220501 {

	public static void main(String[] args) throws Exception {

		// WIKI DUMP FILE
		File dumpFile = new File(
				"C:/usr/local/data/wiki/20220501/enwiktionary-20220501-pages-articles-multistream.xml.bz2");
